...
#include "COCBot\ROROMOD\functions\Config\ScreenCoordinates.au3" ; AIO Mod
#include "COCBot\functions\Config\ImageDirectories.au3"
#include "COCBot\ROROMOD\functions\Config\ImageDirectories.au3" ; AIO Mod
...
Func UpdateBotTitle()
	Local $sTitle = "My Bot " & $g_sBotVersion & " - " & "ROROMOD " & $g_sModVersion & " -" ; AIO Mod
...
Func FinalInitialization(Const $sAI)
	...
	SetLog("_________" & " [   RORO MOD  ]" & "_________", $COLOR_MONEYGREEN, "Impact", 14)
