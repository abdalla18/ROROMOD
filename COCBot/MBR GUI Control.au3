...
; Team AiO MOD++ (2019)
#include "ROROMOD\GUI\MOD GUI Control.au3"
...
Func Bind_ImageList($nCtrl, ByRef $hImageList)
	...
	Switch $nCtrl
		...
		Case $g_hGUI_TRAINARMY_TAB
			...
			Local $aIconIndex = [$eIcnTrain, $eIcnGem,  $eIcnOptions]
		...
		Case $g_hGUI_ATTACK_TAB
			...
			Local $aIconIndex = [$eIcnTrain, $eIcnMagnifier, $eIcnTrain]
		...
		Case $g_hGUI_STRATEGIES_TAB
			...
			Local $aIconIndex = [$eIcnTH12, $eIcnTH11]
