...
Func SetLog($sLogMessage, $iColor = Default, $sFont = Default, $iFontSize = Default, $iStatusbar = Default, $bConsoleWrite = Default, $time = Default, $bEndLine = Default,$FW_BOLD = Default ) ;Sets the text for the log
	If $sLogMessage <> "" Then Return _SetLog($sLogMessage, $iColor, $sFont, $iFontSize, $iStatusbar, $time, $bConsoleWrite, $bEndLine,$FW_BOLD = Default)
EndFunc   ;==>SetLog
...
Func _SetLog($sLogMessage, $Color = Default, $Font = Default, $FontSize = Default, $statusbar = Default, $time = Default, $bConsoleWrite = Default, $bEndLine = Default, _
		$LogPrefix = Default, $bPostponed = Default, $bSilentSetLog = Default, $bWriteToLogFile = Default,$FW_BOLD = Default)

	Local Static $bActive = False
	Local Static $hLogCheckFreeSpaceTimer = 0

	If $Color = Default Then $Color = $COLOR_BLACK
	If $Font = Default Then $Font = "Tahoma Bold"
	If $Font = Default Then $FW_BOLD = 1500
